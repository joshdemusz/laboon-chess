 ...
 */
public class PCGraveyardController extends GraveyardController implements Initializable
{
    @FXML
    private GridPane virtual_graveyard_pc;

    private ArrayList<Piece> logical_graveyard_pc;
    ...
    {
        logical_graveyard_pc = new ArrayList<Piece>();
    ...
    public void clearGraveyard()
    {
        ...
        for(int x = 0; x < 8; x++)
        {
            for(int y = 0; y < 2; y++)
            {
                Node rm1 = getNodeFromGridPane(virtual_graveyard_pc, y, x);
    ...
    private void drawPiece(Piece p, int x, int y)
    {
        ...
        // Add image to grid
        Pane node = (Pane)getNodeFromGridPane(virtual_graveyard_pc, y, x);
    ...
    private static PCGraveyardController instance;
    public PCGraveyardController()
    {
        instance = this;
    }
    // static method to get instance of view
    public static PCGraveyardController getInstance()
    {
        return instance;
    }
}
